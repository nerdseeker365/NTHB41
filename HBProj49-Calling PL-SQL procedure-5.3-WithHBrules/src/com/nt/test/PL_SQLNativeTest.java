...
public class PL_SQLNativeTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			call=ses.createStoredProcedureCall("p_get_emps_by_enos_range",Employee.class);
			...
			call.registerParameter(2, Integer.class, ParameterMode.IN).bindValue(1000);
			call.registerParameter(3,Integer.class, ParameterMode.IN).bindValue(2000);
